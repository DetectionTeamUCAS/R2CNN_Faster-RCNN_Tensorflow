...
if __name__ == "__main__":
    ...
    # file_paths = get_file_paths_recursive('/mnt/USBC/gx/Detection/DOTA/images/', '.png')
    ...
    # inference(det_net, file_paths, '/mnt/USBC/gx/Detection/R2CNN_Tensorflow/tools/demo/', 800, 800,
    #           200, 200, True)
